...
#Setting the password reset through panda frame and compare it to the username 
def reset_passwords(df):
    ...
    if selected_profile == "User":
        ...
        selected_level = st.selectbox("Select a division:", levels)
        ...
        selected_class = st.selectbox("Select a branch:", classes)
