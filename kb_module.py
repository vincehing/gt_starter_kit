...
def docs_uploader():
    ...
    meta = st.text_input("Please enter your document source (Default is SG-GOV):", max_chars=20)
    ...
    if selected_subject == 'New Subject':
        new_subject = st.text_input("Please enter the new function name:", max_chars=30)
    else:
        new_subject = None
    ...
    if selected_topic == 'New Topic':
        new_topic = st.text_input("Please enter the new process name:", max_chars=30)
    else:
        new_topic = None
